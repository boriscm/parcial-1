...
let CafeService = class CafeService {
    ...
    async create(cafe) {
        if (cafe.precio > 0) {
            throw new business_errors_1.BusinessLogicException("The cafe with the given precio is not valid", business_errors_1.BusinessError.PRECONDITION_FAILED);
        }
...
CafeService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(cafe_entity_1.CafeEntity)),
